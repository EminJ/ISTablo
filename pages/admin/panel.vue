        ...
        <div class="w-full h-screen flex justify-center items-center">
            <div class="w-1/4 h-auto border-2 border-slate-400 rounded-lg  px-4 p-1 transition-all hover:shadow-lg hover:shadow-gray-300">
                ...
                <div class="flex justify-end">
                    <a href="/" @click="navigateTo='/'" class="w-auto h-auto py-2 px-8 text-gray-700 my-2 text-center text-lg font-bold rounded inline-block bg-gray-200 hover:bg-red-500 hover:text-white-main transition-all mx-2">Çıkış Yap</a>
